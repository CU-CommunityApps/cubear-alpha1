...
//
    ...
    public function iHaveReinstalled()
    {
        ...
        passthru("terminus --yes drush $site.$env -- --yes site-install cubear_ip --site-name=\"$site_name\" --site-mail=\"$site_mail\" --account-name=admin --account-pass=\"$admin_password\"'");
    }
